...
while (True) :
  t=int(time.time())
  r1=str(random.randint(-5,5)+10*sin(2*pi*(1/864)*t+0)+15)
  r2=str(random.randint(-50,50)+100*sin(2*pi*(1/864)*t+pi/2)+150)
  r3=str(random.randint(-30,30)+150*sin(2*pi*(1/864)*t+pi/3)+180)
  r4=str(random.randint(-400,400)+1100*sin(2*pi*(1/864)*t+pi/4)+1500)
  r5=str(random.randint(-200,200)+1300*sin(2*pi*(1/864)*t+pi/6)+1500)
  r6=str(random.randint(-100,100)+800*sin(2*pi*(1/864)*t-pi/2)+1500)
